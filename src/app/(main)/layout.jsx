...
export default function MainLayout({ children }) {
  let hosts = ['Rob Conery', 'Scott Hanselman']
          ...
          <section className="mt-10 lg:mt-12">
            ...
            >
              {[
                ...
                ['RSS Feed', RSSIcon, "https://feeds.zencastr.com/f/Donxfwf3.rss"],
                ['Scott on Twitter', TwitterIcon, "https://twitter.com/shanselman"],
                ['Rob on Twitter', TwitterIcon, "https://twitter.com/robconery"],
              ].map(([label, Icon, url]) => (
